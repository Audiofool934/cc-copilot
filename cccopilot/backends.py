...
def registry() -> dict:
    ...
    reg = {
        ...
        "mistral":    OpenAICompatBackend("mistral", "https://api.mistral.ai/v1/chat/completions",
                                          "MISTRAL_API_KEY", MODELS.default_for("mistral")),
        "together":   OpenAICompatBackend("together", "https://api.together.xyz/v1/chat/completions",
                                          "TOGETHER_API_KEY", MODELS.default_for("together")),
        "fireworks":  OpenAICompatBackend("fireworks", "https://api.fireworks.ai/inference/v1/chat/completions",
                                          "FIREWORKS_API_KEY", MODELS.default_for("fireworks")),
        "cerebras":   OpenAICompatBackend("cerebras", "https://api.cerebras.ai/v1/chat/completions",
                                          "CEREBRAS_API_KEY", MODELS.default_for("cerebras")),
        "deepinfra":  OpenAICompatBackend("deepinfra", "https://api.deepinfra.com/v1/openai/chat/completions",
                                          "DEEPINFRA_API_KEY", MODELS.default_for("deepinfra")),
        "huggingface": OpenAICompatBackend("huggingface", "https://router.huggingface.co/v1/chat/completions",
                                           "HUGGINGFACE_API_KEY", MODELS.default_for("huggingface")),
        "nvidia":     OpenAICompatBackend("nvidia", "https://integrate.api.nvidia.com/v1/chat/completions",
                                          "NVIDIA_API_KEY", MODELS.default_for("nvidia")),
        "chutes":     OpenAICompatBackend("chutes", "https://llm.chutes.ai/v1/chat/completions",
                                          "CHUTES_API_KEY", MODELS.default_for("chutes")),
        "novita":     OpenAICompatBackend("novita", "https://api.novita.ai/openai/v1/chat/completions",
                                          "NOVITA_API_KEY", MODELS.default_for("novita")),
        "venice":     OpenAICompatBackend("venice", "https://api.venice.ai/api/v1/chat/completions",
                                          "VENICE_API_KEY", MODELS.default_for("venice")),
        "arcee":      OpenAICompatBackend("arcee", "https://api.arcee.ai/api/v1/chat/completions",
                                          "ARCEE_API_KEY", MODELS.default_for("arcee")),
        "gmi":        OpenAICompatBackend("gmi", "https://api.gmi-serving.com/v1/chat/completions",
                                          "GMI_API_KEY", MODELS.default_for("gmi")),
        "stepfun":    OpenAICompatBackend("stepfun", "https://api.stepfun.ai/v1/chat/completions",
                                          "STEPFUN_API_KEY", MODELS.default_for("stepfun")),
        "xiaomi":     OpenAICompatBackend("xiaomi", "https://api.xiaomimimo.com/v1/chat/completions",
                                          "XIAOMI_API_KEY", MODELS.default_for("xiaomi")),
        "volcengine": OpenAICompatBackend("volcengine", "https://ark.cn-beijing.volces.com/api/v3/chat/completions",
                                          "VOLCENGINE_API_KEY", MODELS.default_for("volcengine")),
        "tencent-tokenhub": OpenAICompatBackend(
            "tencent-tokenhub", "https://tokenhub.tencentmaas.com/v1/chat/completions",
            "TENCENT_TOKENHUB_API_KEY", MODELS.default_for("tencent-tokenhub")),
